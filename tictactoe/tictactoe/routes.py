...
def setup_routes(app):
    ...
    app.router.add_view('/game/{game_id}/player', add_player_to_game,
                        name='add_player_game')

    # POST : { 'square': <square_number> } square
    # number is a number from 1 to 9.
    app.router.add_post('/game/{game_id}/player/{player_id}/move',
                        make_move, name='make_move')

    # GET: shows the game current game board
    app.router.add_get('/game/{game_id}/show', show_game_board,
